...
input_dir = '/Users/aftaabhussain/Work/yolo segmentation/B4/Side/annotations'
output_dir = '/Users/aftaabhussain/Work/yolo segmentation/B4/Side/txt_annotations'

# Path to the input image for automatic color extraction
image_for_automatic_path = '/Users/aftaabhussain/Work/yolo segmentation/B4/Side/annotations/1_b4-1_s_69_F.jpg___fuse.png'  # Change this path if you want to use a different image
...
for mask_filename in os.listdir(input_dir):
    ...
    for color in unique_colors:
        ...
        with open('{}.txt'.format(os.path.join(output_dir, mask_filename)[:-15]), 'w') as f:
